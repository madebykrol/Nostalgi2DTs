...
import { listProjects, getProject } from "../controllers/resourceController";
...
router.get("/projects", async (req: Request, res: Response) => listProjects(req, res));
router.get("/projects/:id", async (req: Request, res: Response) => getProject(req, res));
